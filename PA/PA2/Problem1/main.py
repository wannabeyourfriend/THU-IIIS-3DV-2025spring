...
# from render_functions import render_points_batched
...
def render_images(
    ...
    for cam_idx, camera in enumerate(cameras):
        ...
        if cam_idx == 0 and file_prefix == '':
            ...
            plt.imsave('my_images/grid_vis.png', grid_vis)

        # TODO (1): Visualize rays using vis_rays
        if cam_idx == 0 and file_prefix == '':
            rays_vis = vis_rays(ray_bundle, image_size)
            plt.imsave('my_images/rays_vis.png', rays_vis)
        ...
        if cam_idx == 0 and file_prefix == '':
            render_points('my_images/point_vis.png', ray_bundle.sample_points.reshape(1, -1, 3))
